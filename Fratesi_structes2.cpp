...
int main() {
    ...
    for( int i=0; i<N;i++){
        for(int j=0;j<N;j++){
            if(array[i].sezionestudente.anno < array[j].sezionestudente.anno)
            {
                if(array[i].livellostudente.livlet < array[j].livellostudente.livlet)
                {
        ...
        cin>>array[i].nome;
       cout<<"sezione studente "<<i<<endl;
        cout<<array[i].sezionestudente.anno;
        cout<<array[i].sezionestudente.sez;
        cout<<"livello studente "<<i<<endl;
        cout<<array[i].livellostudente.livlet;
        cout<<array[i].livellostudente.livn; 
                }
            }
        }
    }
